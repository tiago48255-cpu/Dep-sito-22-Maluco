...
export function OrderTracker({ status: initialStatus, orderId }: { status: OrderStatus; orderId: string }) {
  ...
  if (status === "cancelado") {
    return (
      <div className="glass-panel rounded-2xl p-6 text-center mx-5 mt-4">
  ...
  return (
    <>
      {/* Map Placeholder */}
      <div className="relative h-44 mx-0 overflow-hidden"
      ...
      {/* Timeline */}
      <div className="glass-panel mx-5 mt-4 rounded-2xl p-5">
      ...
      {(status === "saiu" || status === "entregue") && (
        <div className="glass-panel mx-5 mt-3 rounded-2xl p-4 flex items-center gap-3">
